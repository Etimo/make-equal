...
import {SimpleGridContainer, SimpleGridColumn, SimpleGridRow} from "./Layout-components";
import {frontPageSectionOne, frontPageSectionTwo, frontPageTitle} from '../other/page-text-content';
