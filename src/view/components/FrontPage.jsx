  ...
  render() {
    ...
    return (
      <SimpleGridContainer>
        ...
        <SimpleGridRow>
          <SimpleGridColumn width={10}>{frontPageSectionTwo}</SimpleGridColumn>
        </SimpleGridRow>
        <SimpleGridRow>
        ...
        <SimpleGridRow>
          <SimpleGridColumn>
            <WordDefinitionModal
              word={test1.word}
              wordDefinition={test1.definition}
            />
            <WordDefinitionModal
              word={test2.word}
              wordDefinition={test2.definition}
            />
          </SimpleGridColumn>
        </SimpleGridRow>
      </SimpleGridContainer>
