      ...
      <SimpleGridContainer>
              ...
              <QuestionContainer title={question.text}>
                {question.options.map((option, num) => (
                  <label
                    key={num}
                    className={
                      this.state[question.id] === option.id
                        ? 'option selected'
                        : 'option'
                    }
                  >
                    <OptionRow text={option.text}>
                      <input
                        value={option.id}
                        checked={this.state[question.id] === option.id}
                        type={'radio'}
        ...
        <SimpleGridRow>
          <SimpleGridColumn centered>
            <Button
              content={'Fortsätt med nästa fråga'}
...
const pathSetupInformationText = (
  <p>
    För att frågorna ska vara relevanta för dig behöver du först svara på dessa
    frågor.
  </p>
);
