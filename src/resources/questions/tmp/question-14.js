const question = {
  ...
  options: [
    {
      id: "a", optionText: {noTarget: "Sociala medier",}, subOptions: [
    ...
    {
      id: "b", optionText: {noTarget: "Externa forum",}, subOptions: [
    ...
    {
      id: "d", optionText: {noTarget: "Högerextrema/rasistiska sidor",}, subOptions: [
    ...
    {id: "f", optionText: {noTarget: "Slutna chattgrupper",}, subOptions: [],},
